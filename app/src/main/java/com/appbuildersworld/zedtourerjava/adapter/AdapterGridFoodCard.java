...
public class AdapterGridFoodCard extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void onMoreButtonClick(final View view, final MProductFood p) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, MProductFood obj, int pos);
    }

    public interface OnMoreButtonClickListener {
        void onItemClick(View view, MProductFood obj, MenuItem item);
    }
