...
public class AdapterGridDrinkCard extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void onMoreButtonClick(final View view, final MProductDrinkNonAlc p) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, MProductDrinkNonAlc obj, int pos);
    }

    public interface OnMoreButtonClickListener {
        void onItemClick(View view, MProductDrinkNonAlc obj, MenuItem item);
    }
