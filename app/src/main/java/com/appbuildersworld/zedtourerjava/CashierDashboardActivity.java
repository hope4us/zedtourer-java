...
public class CashierDashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FloatingActionButton) findViewById(R.id.fab_add)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(CashierDashboardActivity.this, AddCashierActivity.class);
                startActivity(i);
            }
        });
    ...
    private void initComponent() {
        ...
        mAdapter.setOnItemClickListener(new AdapterCashierList.OnItemClickListener() {
            ...
            public void onItemClick(View view, MCashier obj, int position) {
                Intent i = new Intent(CashierDashboardActivity.this, CashierDetailsActivity.class);
    ...
    private void getOrders(int businessId) {
    ...
    private void showErrorDialog(final Exception e) {
        ...
        globalErrorDialog.setOnNetResponseListener(new ProcessDialog.NetResponseClickListener() {
            ...
            public void onNetResponseClick() {
                ...
                clickCount++;
                if (clickCount == 6) {
                    final ProcessDialog errorDialog = new ProcessDialog(CashierDashboardActivity.this);
