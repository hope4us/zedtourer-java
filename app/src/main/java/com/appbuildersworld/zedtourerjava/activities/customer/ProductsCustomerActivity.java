...
public class ProductsCustomerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String productsObj = i.getStringExtra("products");
        Log.d("NNN", "Business ID: " + businessId);
        Log.d("NNN", "Products: " + productsObj);
    ...
    private void getBusinessProducts(String products) {
        ...
        getBusinessProductsPDialog.showProcessingDialog("Getting Products and Services.. Please wait..");
                ...
                if (classCall.isCanceled()) {
                    ...
                    try {
                        ...
                        if (productCategories.length() > 0) {
                            ...
                            final ProcessDialog failureDialog = new ProcessDialog(ProductsCustomerActivity.this);

                            failureDialog.showResponseDialog("There are no products and services available at this time", "Continue");
            ...
            for (int i = 0; i < productCategories.length(); i++) {
                ...
                for (int j = 0; j < productsBusiness.length(); j++) {
                    ...
                    if (currentCategoryName.equals("Food")) {
                        ...
                        m.setCategoryName(currentCategoryName);
                        foodList.add(m);
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent i = new Intent(ProductsCustomerActivity.this, CartActivity.class);
    ...
    private void showErrorDialog(final Exception e) {
        ...
        globalErrorDialog.setOnNetResponseListener(new ProcessDialog.NetResponseClickListener() {
            ...
            public void onNetResponseClick() {
                ...
                clickCount++;
                if (clickCount == 6) {
                    final ProcessDialog errorDialog = new ProcessDialog(ProductsCustomerActivity.this);
